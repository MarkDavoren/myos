...
typedef struct
{
    Uint16 limitLow;                    // limit (bits 0-15)
    Uint16 baseLow;                     // base (bits 0-15)
    Uint8  baseMiddle;                  // base (bits 16-23)
    Uint8  access;                      // access
    Uint8  flagsLimitHi;                // limit (bits 16-19) | flags
    Uint8  baseHigh;                    // base (bits 24-31)
} __attribute__((packed)) GDTEntry;

typedef struct
{
    Uint16 limit;                       // sizeof(gdt) - 1
